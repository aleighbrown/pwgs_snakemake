...
rule phylo_input_parsing:
	...
	shell:
		"python2 /data/browna6/pwgs_snakemake/create_phylowgs_inputs.py{params.subsampling}--regions all {params.cnvs} --output-cnvs {output.cnv_parsed} --output-variants {output.ssm_parsed} --output-params {output.params_json} {params.vcf_types} {params.vcf_listing}"
