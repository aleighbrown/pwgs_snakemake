...
--wait-for-files /spin1/users/browna6/pwgs_snakemake/.snakemake/tmp.k_l1d_y5 /data/browna6/evolution/pwgs/phyloinputs/egfr_exome/CL0039/CL0039_T1D_E.params.json /data/browna6/evolution/pwgs/phyloinputs/egfr_exome/CL0039/CL0039_T1D_E.cnvs.txt /data/browna6/evolution/pwgs/phyloinputs/egfr_exome/CL0039/CL0039_T1D_E.ssm.txt --latency-wait 120 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://bitbucket.org/snakemake/snakemake-wrappers/raw/ \
  -p --nocolor \
--notemp --no-hooks --nolock --mode 2  --allowed-rules submit_pwgs  && touch "/spin1/users/browna6/pwgs_snakemake/.snakemake/tmp.k_l1d_y5/5.jobfinished" || (touch "/spin1/users/browna6/pwgs_snakemake/.snakemake/tmp.k_l1d_y5/5.jobfailed"; exit 1)
