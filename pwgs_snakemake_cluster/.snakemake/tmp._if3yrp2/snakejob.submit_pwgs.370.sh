...
--wrapper-prefix https://bitbucket.org/snakemake/snakemake-wrappers/raw/ \
  -p --nocolor \
--notemp --no-hooks --nolock --mode 2  --allowed-rules submit_pwgs  && touch "/spin1/users/browna6/pwgs_snakemake/.snakemake/tmp._if3yrp2/370.jobfinished" || (touch "/spin1/users/browna6/pwgs_snakemake/.snakemake/tmp._if3yrp2/370.jobfailed"; exit 1)
